 ...
 */
export const getFileSizes = async <T extends "int" | "str">(
	rootDir: string,
	filters: Filters = {},
	mode: T = "str" as T,
 ...
 */
export const getDirSizes = async <T extends "int" | "str">(
	rootDir: string,
	filters: Filters = {},
	mode: "int" | "str" = "str",
...
const compareFileBuffer = async (f1: string, f2: string, fileSize?: number): Promise<boolean> => {
	...
	let file1: fsp.FileHandle;
	let file2: fsp.FileHandle;
